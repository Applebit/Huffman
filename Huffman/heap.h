...
{
	template<typename NODETYPE> friend ostream& operator << (ostream&, const Heap <NODETYPE> &);
public:
...
private:
	...
	static int father(int);                    //returns father's location of an item
	static int leftChild(int);                 //returns left child's location of an item
	static int rightChild(int);                //returns right child's location of an item
