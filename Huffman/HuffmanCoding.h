...
{
public:
	void compress(string, string);               //compress input file to output file
...
private:
	...
	void setVariables() const;                        //set needed variable for compress operation
	void writeBits(string);                     //write bits to buffer
	void writeTheFile();                        //write file's buffer to file
	void writeSignature() const;                      //write file's signature (used in compress operation)
